...
public class FreeBoardDAO {
	...
	public void plusView(String boardNum) throws SQLException {
		sqlMap.update("freeboard.plusView", boardNum);
	}
	...
	public FreeBoardVO nextContents(String boardId) throws SQLException {
		FreeBoardVO vo = (FreeBoardVO)sqlMap.queryForObject("freeboard.nextContent", boardId);
		return vo;
	}
	...
	public FreeBoardVO previousContents(String boardId) throws SQLException {
		FreeBoardVO vo = (FreeBoardVO)sqlMap.queryForObject("freeboard.previousContent", boardId);
		return vo;
	}
