...
public class Server_old extends JFrame implements ActionListener {
	...
	private void init() {
		...
		scrollPane.setBounds(12, 10, 337, 241);
		...
		lblNewLabel.setBounds(12, 278, 57, 15);
		contentPane.add(lblNewLabel);

		portTxt = new JTextField();
		portTxt.setBounds(81, 275, 268, 21);
		contentPane.add(portTxt);
		portTxt.setColumns(10);

		startBtn.setBounds(12, 344, 162, 23);
		contentPane.add(startBtn);

		stopBtn.setBounds(175, 344, 174, 23);
			...
			if (protocol.equals("Paper")) {
				...
				for (int i = 0; i < userVc.size(); i++) {
					...
					if (u.nickName.equals(user)) {
						u.sendMessage("Paper/" + nickName + "/" + message);
