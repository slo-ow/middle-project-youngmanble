...
public abstract class TetrisBlock {
	/* TetrisBlock Type - 테트리스 상에 등장하는 블록 타입 설정 변수*/
	...
	/* Rotation Index  - 블록의 움직임에 대한 설정 변수*/
	...
	/* Rotation Type - 시계 방향과 반시계 방향의 차이*/
