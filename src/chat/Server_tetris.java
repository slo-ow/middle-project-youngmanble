...
public class Server_tetris extends JFrame implements ActionListener {
	...
	private void init() {
		...
		JLabel MainLabel = new JLabel("Tetris Server");
		...
		label.setIcon(new ImageIcon(Server_tetris.class.getResource("/imgs/배경.jpg")));
