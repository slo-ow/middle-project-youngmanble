...
public class Client_tetris extends JFrame implements ActionListener{
	...
	private void loginInit() {
		...
		JLabel MainLabel = new JLabel("YongManble Tetris");
		...
		lblNick.setBounds(60, 220, 90, 25);
		...
		label.setIcon(new ImageIcon(Client_tetris.class.getResource("/imgs/로그인창.jpg")));
	...
	private void MainInit() {
		...
		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(Client_tetris.class.getResource("/imgs/Main.jpg")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == loginBtn) {
			...
			if (ipTxt.getText().length() == 0) {
				...
				nickTxt.setText("NickName을 입력해 주세요");
				...
				nick = nickTxt.getText().trim(); // id 받기
			}
